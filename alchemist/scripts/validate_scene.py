...
Usage:
  blender --background alchemist.blend --python validate_scene.py -- \
    --report alchemist/reports/validation.json
...
def main():
    ...
    report = {
        ...
        "usage": "blender --background <scene.blend> --python alchemist/scripts/validate_scene.py -- --report alchemist/reports/validation.json",
