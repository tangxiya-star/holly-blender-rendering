...
def build():
    ...
    area(lightc,'KEY | upper left softbox',(-.23,-.18,.31),(0,0,.04),4.6,(1,.93,.83),.115,.085)
    area(lightc,'FILL | restrained neutral card',(.26,-.19,.19),(0,-.01,.055),.17,(.83,.89,1),.21,.24)
    ...
    target=Vector((.002,0,.045));elev=math.radians(32);distance=.733
    ...
    focus.location=(.003,-.031,.079);focus.empty_display_size=.006
