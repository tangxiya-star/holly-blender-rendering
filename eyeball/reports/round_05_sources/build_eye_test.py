...
def build():
    ...
    area(lightc,'KEY | neutral right window',(.24,-.09,.30),(0,0,.06),3.2,(1,.96,.89),.048,.068)
    area(lightc,'FILL | restrained cool wall bounce',(-.18,-.10,.20),(0,0,.05),.0325,(.67,.80,1),.25,.28)
    area(lightc,'AMBIENCE | quiet overhead room bounce',(.03,.25,.32),(0,.10,0),.12,(.79,.86,1),.36,.32)
    ...
    target=Vector((0,0,.057));elev=math.radians(46);distance=.69
