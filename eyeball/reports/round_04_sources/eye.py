...
def _materials():
    ...
    palette=[(0,(.23,.024,.036)),(.16,(.43,.075,.085)),(.34,(.68,.28,.25)),(.54,(.80,.57,.49)),(.75,(.80,.73,.63)),(1,(.75,.60,.53))]
    ...
    base.color_ramp.interpolation='B_SPLINE';l.new(lower.outputs['Result'],base.inputs[0])
