...
def build():
    ...
    area(lightc,'FILL | restrained cool wall bounce',(-.18,-.10,.20),(0,0,.05),.065,(.67,.80,1),.25,.28)
    area(lightc,'AMBIENCE | quiet overhead room bounce',(.03,.25,.32),(0,.10,0),.18,(.79,.86,1),.36,.32)
