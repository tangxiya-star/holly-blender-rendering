...
def build():
    ...
    key=area(lightc,'KEY | warm left photographic source',(-.17,-.015,.31),(0,0,.07),1.8,(1,.77,.62),.055,.075)
    key.data.spread=math.radians(130)
    area(lightc,'GLINT | small neutral reflection near pupil',(-.055,.17,.39),(0,-.014,.098),.15,(1,.95,.89),.007,.009)
