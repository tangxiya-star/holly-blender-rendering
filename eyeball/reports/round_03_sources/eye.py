...
def _materials():
    ...
    lower.inputs['To Min'].default_value=.96;lower.inputs['To Max'].default_value=0
    ...
    rose=n.new('ShaderNodeMixRGB');rose.inputs[2].default_value=(.43,.065,.125,1)
    ...
    clear,n,l,b=_material('Eye | 65 micron transparent surface film',(.985,.99,.995),.125)
    ...
    l.new(tx.outputs['Object'],ns.inputs['Vector'])
    rr=n.new('ShaderNodeMapRange');rr.inputs['From Min'].default_value=.2;rr.inputs['From Max'].default_value=.8;rr.inputs['To Min'].default_value=.10;rr.inputs['To Max'].default_value=.15
    l.new(ns.outputs['Fac'],rr.inputs['Value']);l.new(rr.outputs['Result'],b.inputs['Roughness'])
