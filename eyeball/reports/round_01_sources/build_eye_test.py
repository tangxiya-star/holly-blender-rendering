...
def build():
    ...
    area(lightc,'KEY | warm left photographic source',(-.18,.035,.29),(0,0,.07),3.0,(1,.79,.60),.045,.065)
    area(lightc,'FILL | violet restaurant illumination',(.20,.015,.21),(0,0,.05),.85,(.24,.06,1),.14,.19)
    area(lightc,'WASH | blue-violet stone ambience',(.04,.28,.22),(0,.16,0),2.3,(.15,.045,1),.26,.19)
    area(lightc,'BOUNCE | subdued front warm card',(-.12,-.25,.13),(0,0,.055),.09,(1,.63,.47),.22,.18)
